...
- **Tests:** 497 → 540 (+43 across 15 new regression test files; +1 added inline to `ChangeSignaturePreviewTests`). Each item ships with a targeted regression suite covering the specific audit repro. Zero test regressions; zero build warnings.
