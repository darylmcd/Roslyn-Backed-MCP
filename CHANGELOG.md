...
- **Backlog:** 21 rows closed across the v6 top-10 pass and the 2026-04-16 backlog sweep:
  ...
  - **Backlog sweep 2026-04-16 — 2 rows so far:**
    - **P3 (1):** `format-range-preview-empty-diff-compile-check-filter-false-clean`.
    - **P4 (1):** `dr-9-12-flag-format-range-empty-returns-empty-diff-on-d`.
- **Tests:** 497 → 524 (+27 across 11 new regression test files). Each item ships with a targeted regression suite covering the specific audit repro. Zero test regressions; zero build warnings.
