...
- **Backlog:** 21 rows closed across the v6 top-10 pass and the 2026-04-16 backlog sweep:
  ...
  - **Backlog sweep 2026-04-16 — 13 rows so far:**
    - **P3 (10):** `format-range-preview-empty-diff-compile-check-filter-false-clean`, `change-signature-preview-brace-concat-on-add-op`, `dr-9-7-reports-during-refactoring-transitions-but-the-w`, `find-references-preview-text-inflates-response`, `change-signature-preview-callsite-summary`, `get-nuget-dependencies-no-summary-mode`, `get-syntax-tree-max-output-chars-incomplete-cap`, `symbol-impact-sweep-output-size-blowup`, `validate-workspace-output-cap-summary-mode`, `dr-9-1-does-not-update-external-consumer-call-sites`.
