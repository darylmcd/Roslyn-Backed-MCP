...
- **Tests:** 497 → 543 (+46 across 16 new regression test files; +1 added inline to `ChangeSignaturePreviewTests`). Each item ships with a targeted regression suite covering the specific audit repro. Zero test regressions; zero build warnings.
