...
| ai_docs/backlog.md | 836 | 1500/4000 | ok |
| ai_docs/workflow.md | 504 | 1500/4000 | ok |
| ai_docs/runtime.md | 1892 | 1500/4000 | warn |
...
- `ai_docs/runtime.md` is still above the 1500-token warn threshold (~1892 tokens). Keep future additions pointer-heavy or split detailed appendices into `ai_docs/references/` if it grows again.
