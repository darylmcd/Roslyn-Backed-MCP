...
public static partial class ServerSurfaceCatalog
{
    ...
    [
        ...
        Resource("server_catalog_version_diff", "server", "experimental", true, false, "Structured surface diff between supported released server catalog versions. Slots: fromVersion + toVersion (v-prefix optional; toVersion also accepts current/latest).", "roslyn://server/catalog-diff/{fromVersion}/{toVersion}"),
