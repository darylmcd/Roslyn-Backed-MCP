...
public static class RoslynPrompts
{
    ...
    private static string SummarizeCodeActions(IReadOnlyList<Company.RoslynMcp.Core.Models.CodeActionDto> codeActions)
    {
    ...
    private static string SummarizeDiagnostics(Company.RoslynMcp.Core.Models.DiagnosticsResultDto diagnostics)
    {
