...
| 2026-04-04 | *(pending)* | `./eng/verify-release.ps1 -Configuration Release` — build OK, **209** tests passed, v1.6.0 stable promotions + coverage uplift; publish + SHA-256 manifest written. |
