# workspace-id-flip-batch-08 — flip read-only `workspaceId` to optional (batch 8 of 11)

**row:** `workspace-id-flip-batch-08` · **pri:** `Low` · **size:** `M` · **deps:** `workspace-id-optional-adoption-evidence,workspace-id-optional-named-argument-prerequisite`
...
- `tests/RoslynMcp.Tests/WorkspaceIdOptionalBatch08Tests.cs` (new — per-batch reflection assertion)
...
|---|---|
| `ExceptionFlowTools.cs` | 1 |
| `FixAllTools.cs` | 1 |
| `ImpactSweepTools.cs` | 1 |
| `InterfaceExtractionTools.cs` | 1 |
