# method-diet-signature-extraction — method-description diet: Signature and extraction slice

**row:** `method-diet-signature-extraction` · **pri:** `Medium` · **size:** `M` · **deps:** `desc-budget-harness-method-family`
...
- `tests/RoslynMcp.Tests/MethodDescriptionDietSignatureExtractionTests.cs` (new — calls the shared harness)
...
|---|---|---|---|---|
| `ParameterObjectTools.cs` | 1 | 217 | 217 | 1 |
| `ChangeSignatureTools.cs` | 1 | 212 | 212 | 1 |
| `ExtractMethodTools.cs` | 3 | 459 | 211 | 1 |

Slice excess over the 200-char ceiling: **40 chars** (~40 excess chars to remove). Three tools barely over the ceiling (217 / 212 / 211 chars) — the smallest edit slice.
