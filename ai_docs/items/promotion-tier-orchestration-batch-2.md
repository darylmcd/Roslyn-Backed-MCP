...
- `PromptShimTools` — `get_prompt_text`
- `ScaffoldingTools` — `scaffold_type_preview`, `scaffold_type_apply`, `scaffold_test_batch_preview`, `scaffold_first_test_file_preview`, `scaffold_test_apply`
- `WorkflowRecommendationTools` — `recommend_workflow`
