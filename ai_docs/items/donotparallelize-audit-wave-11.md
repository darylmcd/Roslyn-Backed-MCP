# donotparallelize-audit-wave-11 — Re-audit serialization opt-outs wave 11

**row:** `donotparallelize-audit-wave-11` · **pri:** `Medium` · **size:** `S`

## Anchors

- `tests/RoslynMcp.Tests/FindReferencesSummaryTests.cs`
- `tests/RoslynMcp.Tests/FindReflectionUsagesPaginationTests.cs`
- `tests/RoslynMcp.Tests/FixAllServiceGuidanceTests.cs`
