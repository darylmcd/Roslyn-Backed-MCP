# donotparallelize-audit-wave-10 — Re-audit serialization opt-outs wave 10

**row:** `donotparallelize-audit-wave-10` · **pri:** `Medium` · **size:** `S`

## Anchors

- `tests/RoslynMcp.Tests/FindOverridesCorlibSuppressionTests.cs`
