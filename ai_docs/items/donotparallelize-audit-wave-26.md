# donotparallelize-audit-wave-26 — Re-audit serialization opt-outs wave 26

**row:** `donotparallelize-audit-wave-26` · **pri:** `Medium` · **size:** `S`

## Anchors

- `tests/RoslynMcp.Tests/ServerInfoPathBoundaryTests.cs`
- `tests/RoslynMcp.Tests/ServiceCoverageTests.cs`
- `tests/RoslynMcp.Tests/Services/NavigationToolsNotFoundMessageTests.cs`
