# donotparallelize-audit-wave-25 — Re-audit serialization opt-outs wave 25

**row:** `donotparallelize-audit-wave-25` · **pri:** `Medium` · **size:** `S`

## Anchors

- `tests/RoslynMcp.Tests/SemanticGrepServiceTests.cs`
- `tests/RoslynMcp.Tests/SemanticSearchFallbackTests.cs`
