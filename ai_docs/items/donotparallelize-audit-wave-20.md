# donotparallelize-audit-wave-20 — Re-audit serialization opt-outs wave 20

**row:** `donotparallelize-audit-wave-20` · **pri:** `Medium` · **size:** `S`

## Anchors

- `tests/RoslynMcp.Tests/PreviewRouteBindingEditingTests.cs`
- `tests/RoslynMcp.Tests/Progress/ProgressEmissionTests.cs`
- `tests/RoslynMcp.Tests/ProjectFilterTests.cs`
