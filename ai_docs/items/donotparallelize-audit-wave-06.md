# donotparallelize-audit-wave-06 — Re-audit serialization opt-outs wave 06

**row:** `donotparallelize-audit-wave-06` · **pri:** `Medium` · **size:** `S`

## Anchors

- `tests/RoslynMcp.Tests/DiagnosticServiceFilterTotalsTests.cs`
- `tests/RoslynMcp.Tests/DiagnosticServicePerfTests.cs`
- `tests/RoslynMcp.Tests/DiagnosticSourceGeneratorParityTests.cs`
