# workspace-id-flip-batch-10 — flip read-only `workspaceId` to optional (batch 10 of 11)

**row:** `workspace-id-flip-batch-10` · **pri:** `Low` · **size:** `M` · **deps:** `workspace-id-optional-adoption-evidence,workspace-id-optional-named-argument-prerequisite`
...
- `tests/RoslynMcp.Tests/WorkspaceIdOptionalBatch10Tests.cs` (new — per-batch reflection assertion)
...
|---|---|
| `RemoveInterfaceMemberTool.cs` | 1 |
| `SuggestionTools.cs` | 1 |
| `SuppressionTools.cs` | 1 |
| `SyntaxTools.cs` | 1 |
