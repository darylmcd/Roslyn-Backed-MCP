# donotparallelize-audit-wave-35 — Re-audit serialization opt-outs wave 35

**row:** `donotparallelize-audit-wave-35` · **pri:** `Medium` · **size:** `S`

## Anchors

- `tests/RoslynMcp.Tests/WindowsPathResourceTests.cs`
