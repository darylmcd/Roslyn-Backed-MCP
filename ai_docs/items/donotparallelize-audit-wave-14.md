# donotparallelize-audit-wave-14 — Re-audit serialization opt-outs wave 14

**row:** `donotparallelize-audit-wave-14` · **pri:** `Medium` · **size:** `S`
...
- `tests/RoslynMcp.Tests/IntegrationTests.SymbolNavigation.cs`
