# donotparallelize-audit-wave-12 — Re-audit serialization opt-outs wave 12

**row:** `donotparallelize-audit-wave-12` · **pri:** `Medium` · **size:** `S`

## Anchors

- `tests/RoslynMcp.Tests/FixAllServiceIntegrationTests.cs`
- `tests/RoslynMcp.Tests/FlowAnalysisServiceTests.cs`
- `tests/RoslynMcp.Tests/GetSyntaxTreeBudgetTests.cs`
