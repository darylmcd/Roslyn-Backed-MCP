# donotparallelize-audit-wave-24 — Re-audit serialization opt-outs wave 24

**row:** `donotparallelize-audit-wave-24` · **pri:** `Medium` · **size:** `S`

## Anchors

- `tests/RoslynMcp.Tests/SecurityDiagnosticIntegrationTests.cs`
- `tests/RoslynMcp.Tests/SelectionRangeCodeActionTests.cs`
- `tests/RoslynMcp.Tests/SemanticExpansionTests.cs`
