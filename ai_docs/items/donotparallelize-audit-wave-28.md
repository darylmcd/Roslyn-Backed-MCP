# donotparallelize-audit-wave-28 — Re-audit serialization opt-outs wave 28

**row:** `donotparallelize-audit-wave-28` · **pri:** `Medium` · **size:** `S`

## Anchors

- `tests/RoslynMcp.Tests/SymbolDisambiguationElicitationTests.cs`
- `tests/RoslynMcp.Tests/SymbolImpactSweepBudgetTests.cs`
