# param-dedupe-advanced-analysis — parameter-description dedupe: Advanced-analysis slice

**row:** `param-dedupe-advanced-analysis` · **pri:** `Low` · **size:** `M` · **deps:** `desc-budget-harness-param-family`

## Anchors

- `src/RoslynMcp.Host.Stdio/Tools/AdvancedAnalysisTools.cs`
- `src/RoslynMcp.Host.Stdio/Tools/AnalysisTools.cs`
- `tests/RoslynMcp.Tests/ParamDescriptionCanonicalAdvancedAnalysisTests.cs` (new — calls the shared harness)
...
Measured on `main` 2026-09-02: this slice carries **120 parameter `[Description]`s totalling 9250 chars** across 2 file(s). Whole-surface uncovered remainder at split time: 36 files, 528 params, 41,760 chars; 16 files (186 params, 12,774 chars) are already covered by the two shipped canonicalization ratchets (PRs #1349, #1350).
