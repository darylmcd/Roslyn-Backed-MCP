# workspace-id-flip-batch-07 — flip read-only `workspaceId` to optional (batch 7 of 11)

**row:** `workspace-id-flip-batch-07` · **pri:** `Low` · **size:** `M` · **deps:** `workspace-id-optional-adoption-evidence,workspace-id-optional-named-argument-prerequisite`
...
- `tests/RoslynMcp.Tests/WorkspaceIdOptionalBatch07Tests.cs` (new — per-batch reflection assertion)
...
|---|---|
| `ConsumerAnalysisTools.cs` | 1 |
| `CouplingAnalysisTools.cs` | 1 |
| `DeadCodeTools.cs` | 1 |
| `EditorConfigTools.cs` | 1 |
