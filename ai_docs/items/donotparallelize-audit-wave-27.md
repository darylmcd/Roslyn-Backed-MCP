# donotparallelize-audit-wave-27 — Re-audit serialization opt-outs wave 27

**row:** `donotparallelize-audit-wave-27` · **pri:** `Medium` · **size:** `S`

## Anchors

- `tests/RoslynMcp.Tests/Services/SymbolInfoNotFoundMessageTests.cs`
