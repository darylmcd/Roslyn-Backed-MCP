...
- `ApplyWithVerifyTool` — `apply_with_verify`
- `BulkRefactoringTools` — `bulk_replace_type_apply`, `replace_invocation_preview`
- `ChangeSignatureTools` — `change_signature_preview`

Batch candidates: **4**. Whole surface at split time: 174 tools = 113 stable + 61 experimental.
