# donotparallelize-audit-wave-15 — Re-audit serialization opt-outs wave 15

**row:** `donotparallelize-audit-wave-15` · **pri:** `Medium` · **size:** `S`

## Anchors

- `tests/RoslynMcp.Tests/IntegrationTests.WorkspaceCore.cs`
- `tests/RoslynMcp.Tests/MemberHierarchyCrossToolConsistencyTests.cs`
- `tests/RoslynMcp.Tests/MetadataNameLocatorTests.cs`
