# donotparallelize-audit-wave-17 — Re-audit serialization opt-outs wave 17

**row:** `donotparallelize-audit-wave-17` · **pri:** `Medium` · **size:** `S`

## Anchors

- `tests/RoslynMcp.Tests/NuGetDependencySummaryTests.cs`
- `tests/RoslynMcp.Tests/NuGetVulnerabilityScanIntegrationTests.cs`
- `tests/RoslynMcp.Tests/P4BehavioralBundleTests.cs`
