# method-diet-restructure-interface — method-description diet: Restructure and interface slice

**row:** `method-diet-restructure-interface` · **pri:** `Medium` · **size:** `M` · **deps:** `desc-budget-harness-method-family`

## Anchors

- `src/RoslynMcp.Host.Stdio/Tools/RestructureTools.cs`
- `src/RoslynMcp.Host.Stdio/Tools/RemoveInterfaceMemberTool.cs`
- `src/RoslynMcp.Host.Stdio/Tools/SyntaxTools.cs`
- `src/RoslynMcp.Host.Stdio/Tools/InterfaceExtractionTools.cs`
- `tests/RoslynMcp.Tests/MethodDescriptionDietRestructureInterfaceTests.cs` (new — calls the shared harness)
...
|---|---|---|---|---|
| `RestructureTools.cs` | 2 | 480 | 262 | 2 |
| `RemoveInterfaceMemberTool.cs` | 1 | 279 | 279 | 1 |
| `SyntaxTools.cs` | 1 | 219 | 219 | 1 |
| `InterfaceExtractionTools.cs` | 2 | 266 | 217 | 1 |

Slice excess over the 200-char ceiling: **195 chars** (~195 excess chars to remove). Six tools, five marginally over the ceiling (max 279 chars).
