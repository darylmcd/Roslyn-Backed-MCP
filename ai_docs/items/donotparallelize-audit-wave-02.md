# donotparallelize-audit-wave-02 — Re-audit serialization opt-outs wave 02

**row:** `donotparallelize-audit-wave-02` · **pri:** `Medium` · **size:** `S`

## Anchors

- `tests/RoslynMcp.Tests/AnalyzerShadowLoaderLifecycleTests.cs`
- `tests/RoslynMcp.Tests/AuditFixesTests.cs`
- `tests/RoslynMcp.Tests/AutoReloadCascadeHostCrashTests.cs`
