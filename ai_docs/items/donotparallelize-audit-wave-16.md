# donotparallelize-audit-wave-16 — Re-audit serialization opt-outs wave 16

**row:** `donotparallelize-audit-wave-16` · **pri:** `Medium` · **size:** `S`

## Anchors

- `tests/RoslynMcp.Tests/MissingWorkspaceRootRetirementTests.cs`
- `tests/RoslynMcp.Tests/MutationAnalysisSideEffectsTests.cs`
