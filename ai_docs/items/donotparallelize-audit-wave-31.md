# donotparallelize-audit-wave-31 — Re-audit serialization opt-outs wave 31

**row:** `donotparallelize-audit-wave-31` · **pri:** `Medium` · **size:** `S`

## Anchors

- `tests/RoslynMcp.Tests/Top10V2RegressionTests.cs`
- `tests/RoslynMcp.Tests/Top10V3RegressionTests.cs`
- `tests/RoslynMcp.Tests/TypeConsumersServiceTests.cs`
