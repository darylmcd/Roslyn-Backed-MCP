# donotparallelize-audit-wave-13 — Re-audit serialization opt-outs wave 13

**row:** `donotparallelize-audit-wave-13` · **pri:** `Medium` · **size:** `S`

## Anchors

- `tests/RoslynMcp.Tests/GetSyntaxTreeRangeOverlapTests.cs`
- `tests/RoslynMcp.Tests/GoToTypeDefinitionTests.cs`
