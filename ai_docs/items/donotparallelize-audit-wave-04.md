# donotparallelize-audit-wave-04 — Re-audit serialization opt-outs wave 04

**row:** `donotparallelize-audit-wave-04` · **pri:** `Medium` · **size:** `S`

## Anchors

- `tests/RoslynMcp.Tests/CodeActionServiceTests.cs`
- `tests/RoslynMcp.Tests/CompileCheckZeroProjectsTests.cs`
- `tests/RoslynMcp.Tests/ConsumerAnalysisTests.cs`
