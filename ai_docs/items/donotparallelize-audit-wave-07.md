# donotparallelize-audit-wave-07 — Re-audit serialization opt-outs wave 07

**row:** `donotparallelize-audit-wave-07` · **pri:** `Medium` · **size:** `S`

## Anchors

- `tests/RoslynMcp.Tests/DocumentSymbolsSymbolHandleTests.cs`
- `tests/RoslynMcp.Tests/DotnetCommandRunnerPipeLifetimeTests.cs`
- `tests/RoslynMcp.Tests/ExpandedSurfaceIntegrationTests.CoverageProcess.cs`
