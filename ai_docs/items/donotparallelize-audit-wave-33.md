# donotparallelize-audit-wave-33 — Re-audit serialization opt-outs wave 33

**row:** `donotparallelize-audit-wave-33` · **pri:** `Medium` · **size:** `S`

## Anchors

- `tests/RoslynMcp.Tests/UnusedSymbolsTestBridgeExclusionTests.cs`
- `tests/RoslynMcp.Tests/ValidateRecentGitChangesTests.cs`
- `tests/RoslynMcp.Tests/ValidateWorkspaceChangeTrackerReconcileTests.cs`
