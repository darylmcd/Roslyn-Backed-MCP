# donotparallelize-audit-wave-36 — Re-audit serialization opt-outs wave 36

**row:** `donotparallelize-audit-wave-36` · **pri:** `Medium` · **size:** `S`

## Anchors

- `tests/RoslynMcp.Tests/Workspace/WorkspaceLoadCacheFastPathTests.cs`
