# donotparallelize-audit-wave-22 — Re-audit serialization opt-outs wave 22

**row:** `donotparallelize-audit-wave-22` · **pri:** `Medium` · **size:** `S`

## Anchors

- `tests/RoslynMcp.Tests/RefactoringToolsIntegrationTests.cs`
- `tests/RoslynMcp.Tests/ReferenceServiceFindImplementationsTests.cs`
