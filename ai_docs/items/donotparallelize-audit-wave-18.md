# donotparallelize-audit-wave-18 — Re-audit serialization opt-outs wave 18

**row:** `donotparallelize-audit-wave-18` · **pri:** `Medium` · **size:** `S`

## Anchors

- `tests/RoslynMcp.Tests/PerformanceBaselineTests.cs`
- `tests/RoslynMcp.Tests/PerformanceBehaviorTests.cs`
