# donotparallelize-audit-wave-19 — Re-audit serialization opt-outs wave 19

**row:** `donotparallelize-audit-wave-19` · **pri:** `Medium` · **size:** `S`

## Anchors

- `tests/RoslynMcp.Tests/PostApplySymbolRotationTests.cs`
