# donotparallelize-audit-wave-30 — Re-audit serialization opt-outs wave 30

**row:** `donotparallelize-audit-wave-30` · **pri:** `Medium` · **size:** `S`

## Anchors

- `tests/RoslynMcp.Tests/TestReferenceMapServiceTests.cs`
- `tests/RoslynMcp.Tests/ToolCallErrorWireContractTests.cs`
