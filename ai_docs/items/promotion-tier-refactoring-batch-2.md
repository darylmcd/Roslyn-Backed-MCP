...
- `ExtractMethodTools` — `extract_method_apply`, `extract_shared_expression_to_helper_preview`
- `FixAllTools` — `fix_all_preview`, `fix_all_apply`
- `InterfaceExtractionTools` — `extract_interface_preview`, `extract_interface_apply`
