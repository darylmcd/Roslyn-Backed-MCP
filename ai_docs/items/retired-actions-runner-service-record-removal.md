...
2026-08-27 live recheck: repository runner API returned total_count=0; no retired runner processes were observed; C:/Users/daryl/actions-runner and C:/Users/daryl/actions-runner.retired-20260824 were absent. The stopped Automatic LocalSystem service record still exists at the retired RunnerService.exe path. Exact sc.exe delete failed with OpenService error 5 (Access is denied), so elevated deletion plus post-reboot proof remain required and the row stays open.
