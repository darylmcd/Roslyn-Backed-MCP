# donotparallelize-audit-wave-29 — Re-audit serialization opt-outs wave 29

**row:** `donotparallelize-audit-wave-29` · **pri:** `Medium` · **size:** `S`

## Anchors

- `tests/RoslynMcp.Tests/SymbolRelationshipsBuiltinTypeSuppressionTests.cs`
