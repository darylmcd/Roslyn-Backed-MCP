...
**Budget** — no fixed session cap; record extraction is cheap. If you must truncate, keep per-source balance, list the dropped sessions and why in §0, and set `truncated: true`.
