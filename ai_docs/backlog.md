...
**updated_at:** 2026-07-27T00:18:46Z
...
| `document-set-persistence-transactional-rollback` | Medium | — | **Transactional document-set persistence** — snapshot and compensate every file/project mutation when a later persistence step fails. [type: bug] [source: 2026-07-26 cq] | M | items/document-set-persistence-transactional-rollback.md |
| `workspace-fork-restore-error-redaction` | Medium | — | **Redact fork restore failures** — replace raw stdout/stderr exception text with a bounded credential-safe client summary. [type: security] [source: 2026-07-26 cq] | S | items/workspace-fork-restore-error-redaction.md |
...
| `refactoringservice-remaining-complexity-decomposition` | Low | — | **Split remaining RefactoringService hotspots** — extract the rebase, rename-summary, and file-snapshot complexity clusters. [type: refactor] [source: 2026-07-26 cq] | S | items/refactoringservice-remaining-complexity-decomposition.md |
| `coupling-analysis-compute-hotspot-decomposition` | Low | — | **Decompose coupling-analysis hotspots** — split efferent classification and result orchestration while preserving partial semantics. [type: refactor] [source: 2026-07-26 cq] | S | items/coupling-analysis-compute-hotspot-decomposition.md |
| `workspace-fork-apply-orchestration-decomposition` | Low | — | **Decompose fork-apply orchestration** — separate lifecycle, validation, and retention state transitions in the extracted service. [type: refactor] [source: 2026-07-26 cq] | S | items/workspace-fork-apply-orchestration-decomposition.md |
| `validate-recent-git-changes-error-boundary` | Low | — | **Retire duplicate validation error boundary** — route validate_recent_git_changes failures through StructuredCallToolFilter. [type: refactor] [source: 2026-07-26 cq] | S | items/validate-recent-git-changes-error-boundary.md |
| `stdio-shutdown-flush-observability` | Low | — | **Observe shutdown flush failures** — preserve no-throw shutdown while reporting transport flush faults outside MCP stdout. [type: reliability] [source: 2026-07-26 cq] | S | items/stdio-shutdown-flush-observability.md |
