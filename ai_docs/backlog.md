...
| `undo-file-snapshot-byte-fidelity` | Medium | — | Preserve exact bytes and encoding across refactoring apply undo snapshots. | M | items/undo-file-snapshot-byte-fidelity.md |
| `project-file-mutation-byte-fidelity` | Medium | — | Preserve project-file encoding and BOM during project-reference writes. | M | items/project-file-mutation-byte-fidelity.md |
