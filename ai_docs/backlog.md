...
**updated_at:** 2026-08-07T19:57:35Z
...
| `adr-0001-location-migration-corrections` | Medium | — | **Correct ADR 0001's producer survey + null-location semantics** — producer count is 8 not 5, and two producers construct DiagnosticDto with a null FilePath the ADR's stated shape can't represent. [type: docs] [source: PR #1180 code-quality review] | M | items/adr-0001-location-migration-corrections.md |
