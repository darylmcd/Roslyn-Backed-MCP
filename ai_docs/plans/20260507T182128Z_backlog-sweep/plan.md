...
| Field | Content |
|---|---|
| Status | merged (PR #547, 2026-05-07) |
...
| Field | Content |
|---|---|
| Status | merged (PR #550, 2026-05-07) |
...
| Field | Content |
|---|---|
| Status | merged (PR #551, 2026-05-07) |
...
| Field | Content |
|---|---|
| Status | in-progress (branch: remediation/per-repo-promotion-scorecard, worktree: .worktrees/per-repo-promotion-scorecard) |
