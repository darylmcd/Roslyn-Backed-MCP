...
| I-35 | `dr-9-2-format-bug-001-cross-project-interface-extractio` | 1 | 50000 | Fixed | in-review — `CrossProjectRefactoringService.CreateCompilationUnitForMember` gains `normalizeWhitespace` flag; `AddBaseType` + new `EnsureOpeningBraceOnOwnLine` helper mirror `InterfaceExtractionService`. |
