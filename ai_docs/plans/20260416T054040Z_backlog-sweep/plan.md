...
| I-29 | `dr-9-6-ignores-generic-arguments-in-implemented-interfa` | 1 | 40000 | Fixed | in-progress (branch: remediation/dr-9-6-ignores-generic-arguments-in-implemented-interfa, worktree: .worktrees/dr-9-6-ignores-generic-arguments-in-implemented-interfa). `bulk_replace_type scope=parameters` walks generic args. |
